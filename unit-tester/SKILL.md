...
3. **既存テストパターンに従う** — プロジェクトのモック構成・ヘルパーを踏襲
4. **テスト名で仕様を表現** — テスト名だけ読めば仕様が分かるように書く
5. **独立性** — テスト間の依存をなくす。各テストが単独で実行可能
...
### テストデータ規約
- UUID: `00000000-0000-0000-0000-000000000001` 形式
- storeId: テスト用固定値（helpers.ts で定義）
